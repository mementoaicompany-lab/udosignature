...
for route,p in P.items():
 ...
 if p.get('redirect'):
  ...
  top='비공개 디자인 시안 · 실제 오픈·메뉴·영업 정보가 아닙니다' if C['private'] else '우도 여행과 로컬 브랜드를 한곳에서'
